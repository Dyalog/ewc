...
Only tested with Dyalog 20 and above

### Improved

- Fixes an issue where ambivalent callbacks were called in correctly.
  This had effects on DQ and such.
- Fixes an issue with a callback getting registered in #.EWC rather than #.
- Changes to error propagation and returning stack traces
